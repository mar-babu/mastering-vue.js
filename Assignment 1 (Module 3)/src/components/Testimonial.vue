...
const testimonials =  [
    {
        ...
        name: "James Anderson",
        position: "Facebook, Product Lead",
    },
    {
        quote: "Separated they live in Bookmarksgrove right at the coast of the Semantics",
        image: "src/assets/images/person_2.jpg",
        name: "John Doe",
        position: "Twitter, Marketing Manager",
    },
    {
        quote: "Separated they live in Bookmarksgrove right at the coast of the Semantics",
        image: "src/assets/images/person_3.jpg",
        name: "Jane Smith",
        position: "Instagram, UX Designer",
    },
];
</script>
            ...
            <div class="row">
                <div class="col-lg-4 mb-5 text-center text-lg-left mb-lg-0" data-aos="fade-up" data-aos-delay="0">
                    <div class="mb-4">
                        ...
                        <h2 class="heading">Our Customers Feedback</h2>
                    </div>
                    <div>
                        <a href="#" class="js-custom-prev-v2 cusotm-slider-nav custom-prev" @click="prevSlide">
                            <span>
                                <svg class="bi bi-arrow-left" width="1em" height="1em" viewBox="0 0 16 16"
                        ...
                        <a href="#" class="js-custom-next-v2 cusotm-slider-nav custom-next" @click="nextSlide">
                            <span>
                ...
                <div class="col-lg-8" data-aos="fade" data-aos-delay="200">
                    <div class="owl-2-slider owl-carousel">
                        <div v-for="(item, index) in testimonials" :key="index" class="item">
                            <div class="untree_co-testimonial d-flex">
                                <div class="text">
                                    <blockquote>
                                        &ldquo;<span class="highlight">{{ item.quote }}</span>, a large language ocean. A
                                    ...
                                    <div class="author d-flex">
                                        ...
                                        <div>
                                            <strong class="d-block">{{ item.name }}</strong><span class="d-block">{{
                                                item.position }}</span>
                                        </div>
                                    </div>
                                </div>
